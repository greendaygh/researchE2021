...
![](images/Screenshot from 2021-04-22 12-43-04.png)
...
이제 index.Rmd 파일을 열고 Knit 버튼으로 컴파일을 하면 `_site` 디렉토리에 index.html 등 웹사이트에 필요한 파일들이 들어갑니다. about.Rmd 파일도 같은 방법으로 Knit 버튼으로 컴파일을 해주고 앞에서 배운 Git 툴이나 터미널로 원격저장소에 업데이트를 수행합니다. 
