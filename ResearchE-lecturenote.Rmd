...
knitr::include_graphics("material/210311/2-2 iGEM Team 선정 박성군.pdf")

```

```{r, fig.align="center", fig.cap=c("김태현"), echo=FALSE}
knitr::include_graphics("material/210311/210311 현장연구_김태현_210311_160543.pdf")

```

```{r, fig.align="center", fig.cap=c("이진주"), echo=FALSE}
knitr::include_graphics("material/210311/210311 iGEM 팀 선정-이진주.pdf")

```

```{r, fig.align="center", fig.cap=c("유병현"), echo=FALSE}
knitr::include_graphics("material/210311/iGEM 유병현.pdf")

```

```{r, fig.align="center", fig.cap=c("Aporva"), echo=FALSE}
knitr::include_graphics("material/210311/iGEM_AporvaGupta.pdf")

```

```{r, fig.align="center", fig.cap=c("Georgii"), echo=FALSE}
knitr::include_graphics("material/210311/iGEM_Georgii.pdf")

```

```{r, fig.align="center", fig.cap=c("오석진"), echo=FALSE}
knitr::include_graphics("material/210311/igem_오석진.pdf")

```

```{r, fig.align="center", fig.cap=c("김승화"), echo=FALSE}
knitr::include_graphics("material/210311/현장연구 E 210311 수업 김승화.pdf")

```

```{r, fig.align="center", fig.cap=c("허성보"), echo=FALSE}
knitr::include_graphics("material/210311/iGEM_허성보.pdf")
...
-   강좌용 GitHub web page <https://greendaygh.github.io/researchE2021/>{target="_blank_"}
...
-   (계속) Rstudio 사용법, Rmarkdown 만드는 방법 익히기
-   Github page 만들기
-   Git 사용법 익히기
...
[github-page-20210315.html](github-page-20210315.html)
