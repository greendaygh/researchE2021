...
# researcheweb 페이지 업데이트 {#researchewebupdate}

-   [Remotemeeting 링크](){target="_blank_"}

## 수업목표 (2021. 5. 10. 월) {.unnumbered}

- 지난 시간 만들었던 researcheweb 사이트 완성
- 메뉴 구성: `_site.yml` 파일에 다음과 같은 구성으로 메뉴 구성
  - Introduction
  - Methods
  - Results 
  - Discussion
  - 예를 들어 Introduction의 경우 
